...
- После прокачки во время паузы надо дать возможность ехать 
- Шрифт в меню - не нравится
- Нужна объяснить цель игры
- Возрождение периодически не работает
- Лагает при большом кол-во соперников
