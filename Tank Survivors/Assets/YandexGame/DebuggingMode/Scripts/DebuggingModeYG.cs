...
{
    [HelpURL(
        "https://www.notion.so/PluginYG-d457b23eee604b7aa6076116aab647ed#4968547185c2460fb70fd6eceaf101d4"
    )]
    public class DebuggingModeYG : MonoBehaviour
    {
...
#else
            if (YandexGame.EnvironmentData.payload == payloadPassword)
                draw = true;
#endif
            if (draw)
            {
                ...
                tr.Find("Panel").Find("LanguageDebug").GetChild(0).GetComponent<Text>().text =
                ...
                tr.Find("Panel").Find("DebugData").GetChild(0).GetComponent<Text>().text =
                    "playerName - "
                    ...
                    + "\nbrowser - "
                    + YandexGame.EnvironmentData.browser;
            }
        }
        ...
        public void VideoAdButton()
        {
            ...
            int id = int.Parse(
                tr.Find("Panel").Find("RewardAd").GetChild(0).GetComponent<InputField>().text
            );
        ...
        public void NewScoreLB()
        {
            YandexGame.NewLeaderboardScores(
                leaderboard.leaderboardYG.nameLB,
        ...
        {
            YandexGame.NewLBScoreTimeConvert(
                leaderboard.leaderboardYG.nameLB,
