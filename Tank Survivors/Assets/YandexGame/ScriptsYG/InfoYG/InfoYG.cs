...
namespace YG
{
    ...
    public partial class InfoYG : ScriptableObject
    {
        ...
        [Tooltip(
            "Выдавать вознаграждение за просмотр рекламы только после закрытия рекламы?\n(true = после закрытия, false = сразу после того как таймер закончит свой отчёт)"
        )]
        ...
        [Tooltip(
            "Нажмите галочку, чтобы сэмулировать вызов ошибки при просмотре рекламы за вознаграждение. (Только для Unity Editor)"
        )]
        ...
        {
            [Tooltip(
                "Имя объекта, который содержит нужный метод для выполнения после закрытия игры."
            )]
        ...
        public QuitGameMethod quitGameParameters =
            new() { objectName = "YandexGame", methodName = "_SaveProgress" };
        ...
        [
            ConditionallyVisible(nameof(leaderboardEnable)),
        ...
        public LBData[] leaderboardSimulation = new LBData[]
        {
            new()
            {
                ...
                type = "numeric",
                thisPlayer = new LBThisPlayerData { rank = 2, score = 10, }
            },
            new()
            {
                technoName = "simple",
        ...
        public class FontsTMP
        {
            ...
            [Tooltip("RUSSIAN")]
            public TMP_FontAsset[] ru;

            [Tooltip("ENGLISH")]
            public TMP_FontAsset[] en;

            [Tooltip("TURKISH")]
            public TMP_FontAsset[] tr;

            [Tooltip("AZERBAIJANIAN")]
            public TMP_FontAsset[] az;

            [Tooltip("BELARUSIAN")]
            public TMP_FontAsset[] be;

            [Tooltip("HEBREW")]
            public TMP_FontAsset[] he;

            [Tooltip("ARMENIAN")]
            public TMP_FontAsset[] hy;

            [Tooltip("GEORGIAN")]
            public TMP_FontAsset[] ka;

            [Tooltip("ESTONIAN")]
            public TMP_FontAsset[] et;

            [Tooltip("FRENCH")]
            public TMP_FontAsset[] fr;

            [Tooltip("KAZAKH")]
            public TMP_FontAsset[] kk;

            [Tooltip("KYRGYZ")]
            public TMP_FontAsset[] ky;

            [Tooltip("LITHUANIAN")]
            public TMP_FontAsset[] lt;

            [Tooltip("LATVIAN")]
            public TMP_FontAsset[] lv;

            [Tooltip("ROMANIAN")]
            public TMP_FontAsset[] ro;

            [Tooltip("TAJICK")]
            public TMP_FontAsset[] tg;

            [Tooltip("TURKMEN")]
            public TMP_FontAsset[] tk;

            [Tooltip("UKRAINIAN")]
            public TMP_FontAsset[] uk;

            [Tooltip("UZBEK")]
            public TMP_FontAsset[] uz;

            [Tooltip("SPANISH")]
            public TMP_FontAsset[] es;

            [Tooltip("PORTUGUESE")]
            public TMP_FontAsset[] pt;

            [Tooltip("ARABIAN")]
            public TMP_FontAsset[] ar;

            [Tooltip("INDONESIAN")]
            public TMP_FontAsset[] id;

            [Tooltip("JAPANESE")]
            public TMP_FontAsset[] ja;

            [Tooltip("ITALIAN")]
            public TMP_FontAsset[] it;

            [Tooltip("GERMAN")]
            public TMP_FontAsset[] de;

            [Tooltip("HINDI")]
            public TMP_FontAsset[] hi;
        }
