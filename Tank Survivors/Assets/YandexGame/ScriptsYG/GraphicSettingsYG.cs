...
namespace YG
{
    public class GraphicSettingsYG : MonoBehaviour
    {
        ...
        [Header("Translate")]
        [SerializeField]
        private string[] ru = new string[6];

        [SerializeField]
        private string[] en = new string[6];

        [SerializeField]
        private string[] tr = new string[6];

        [SerializeField]
        private string[] az = new string[6];

        [SerializeField]
        private string[] be = new string[6];

        [SerializeField]
        private string[] he = new string[6];

        [SerializeField]
        private string[] hy = new string[6];

        [SerializeField]
        private string[] ka = new string[6];

        [SerializeField]
        private string[] et = new string[6];

        [SerializeField]
        private string[] fr = new string[6];

        [SerializeField]
        private string[] kk = new string[6];

        [SerializeField]
        private string[] ky = new string[6];

        [SerializeField]
        private string[] lt = new string[6];

        [SerializeField]
        private string[] lv = new string[6];

        [SerializeField]
        private string[] ro = new string[6];

        [SerializeField]
        private string[] tg = new string[6];

        [SerializeField]
        private string[] tk = new string[6];

        [SerializeField]
        private string[] uk = new string[6];

        [SerializeField]
        private string[] uz = new string[6];

        [SerializeField]
        private string[] es = new string[6];

        [SerializeField]
        private string[] pt = new string[6];

        [SerializeField]
        private string[] ar = new string[6];

        [SerializeField]
        private string[] id = new string[6];

        [SerializeField]
        private string[] ja = new string[6];

        [SerializeField]
        private string[] it = new string[6];

        [SerializeField]
        private string[] de = new string[6];

        [SerializeField]
        private string[] hi = new string[6];
        private int labelBaseFontSize,
            itemBaseFontSize;
