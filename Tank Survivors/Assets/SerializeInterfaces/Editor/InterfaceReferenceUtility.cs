    ...
    internal static class InterfaceReferenceUtility
    {
        ...
        public static void OnGUI(Rect position, SerializedProperty property, GUIContent label, InterfaceObjectArguments args)
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                UnityEngine.Object newVal = GetClosestAssignableComponent(property.objectReferenceValue, args);
        ...
        private static void OpenDelayed(SerializedProperty property, InterfaceObjectArguments args)
        {
            ...
            ObjectSelectorWindow.Show(property, obj => { property.objectReferenceValue = obj; _ = property.serializedObject.ApplyModifiedProperties(); }, (obj, success) => { if (success) { property.objectReferenceValue = obj; } }, filter);
        ...
        private static bool IsAssignedAndHasWrongInterface(UnityEngine.Object obj, InterfaceObjectArguments args)
        {
