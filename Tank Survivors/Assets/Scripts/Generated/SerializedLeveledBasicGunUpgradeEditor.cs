...
{
    [CustomPropertyDrawer(typeof(SerializedLeveledBasicGunUpgrade))]
    public class SerializedLeveledBasicGunUpgradeDrawer : PropertyDrawer
    {
        private string[] implementingTypeNames = { "BasicGunDamageUp" };
